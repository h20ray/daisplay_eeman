...
class Sidebar extends StatelessWidget {
  ...
  List<Widget> _buildItems(BuildContext context) {
    return [
      ...
      // Soundcloud
      _Item(
        svgFileName: 'assets/icons/soundcloud.svg',
        title: Language.soundcloud,
        visible: Config.soundcloud.isNotEmpty,
        onTap: () async {
          ScaffoldController.scaffoldKey.currentState?.closeDrawer();
          await launchUrl(Uri.parse(Config.soundcloud),
              mode: LaunchMode.externalApplication);
        },
      ),
      ...
      // Youtube
      _Item(
        svgFileName: 'assets/icons/youtube.svg',
        title: Language.youtube,
        visible: Config.youtube.isNotEmpty,
        onTap: () async {
          ScaffoldController.scaffoldKey.currentState?.closeDrawer();
          await launchUrl(Uri.parse(Config.youtube),
              mode: LaunchMode.externalApplication);
        },
      ),
